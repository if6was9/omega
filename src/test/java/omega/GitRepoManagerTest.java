...
public class GitRepoManagerTest {
  ...
  public void testIt() throws IOException {
    ...
    MoreFiles.deleteRecursively(new File(mm.getBaseDir(),".git/objects").toPath(),RecursiveDeleteOption.ALLOW_INSECURE);
  ...
  public void testTargetRef() throws IOException {
    ...
    mm.update();
    Assertions.assertThat(mm.getCurrentRevision()).isEqualTo("3fd1a742428cae0ad8e18f4cfd5a7720e04c4661");
    Assertions.assertThat(mm.getBranchOrRef()).isEqualTo("3fd1a742428cae0ad8e18f4cfd5a7720e04c4661");
    ...
    Assertions.assertThat(mm.getBranchOrRef()).isEqualTo("refs/heads/main");
    Assertions.assertThat(mm.getCurrentRevision()).isNotEqualTo("3fd1a742428cae0ad8e18f4cfd5a7720e04c4661");
